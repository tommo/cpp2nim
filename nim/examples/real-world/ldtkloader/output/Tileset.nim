...
proc getTileTexturePos*[T](self: ptr Tileset, tile_id: cint): IntPoint {.importcpp: "getTileTexturePos".}
...
proc getEnumTagsEnum*[E, T](self: ptr Tileset): var Enum {.importcpp: "getEnumTagsEnum".}
